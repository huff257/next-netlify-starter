            ...
            <div id="mobile-btn">
                ...
                <div className="sidebar">
                    <div className="fixed pc_box_shadow">
                        <div id="nav-icon" className="btn-spans nav-icon sidebar-x" onclick="openMenu()">
                            <span></span>
                            <span></span>
                            <span></span>
                            <span></span>
                        </div>
                        <div className="fixed_col pc_center_align bg_white neg_margin intro" style="box-shadow: 0 2px 3px 0 rgb(15 15 20 / 20%);">
                            <div className="pc_img_wrapper">
                                <img src={profilePic} alt='Picture of Kyle'/>
                        ...
                        <div className="pc_scroll_content">
                            ...
                            <div className="fixed_col">
                                ...
                                <div className="pc_contact-child pc_space_evenly" style="margin-top: -0.5rem;">
                            ...
                            <div className="fixed_col" style="border: none;">
                        ...
                        <div className="fixed_col pc_gray_bg pc_white neg_margin fixed_bottom" style="border: none;">
